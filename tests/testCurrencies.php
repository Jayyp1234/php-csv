...
class Currencies extends PHPUnit_Framework_TestCase {
    ...
    public function testFind(){
        $response = $this->http->request('GET', 'api/currencies');
